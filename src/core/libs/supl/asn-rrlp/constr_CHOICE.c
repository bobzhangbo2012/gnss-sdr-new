 ...
 * See the definitions.
 */
static int _fetch_present_idx(const void *struct_ptr, int pres_offset, int pres_size);
static void _set_present_idx(void *struct_ptr, int pres_offset, int pres_size, int present);
